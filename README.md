...
It is recommended to do the following to validate the setup of the artifact (should complete in under 45 minutes depending on your system). Doing so will result  in running end-to-end on a single benchmark by running each experiment configuration once and timing out if a configuration runs for over 5 seconds.
