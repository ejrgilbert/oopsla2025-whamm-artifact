...
class TqWasmTypeInfo : public TqHeapObject {
 public:
  ...
  bool IsSuperclassOf(const TqObject* other) const override;
  uintptr_t GetCanonicalTypeIndexAddress() const;
  Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetCanonicalTypeIndexValue(d::MemoryAccessor accessor ) const;
