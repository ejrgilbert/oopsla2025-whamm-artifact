...
TF_BUILTIN(FastFunctionPrototypeBind, CodeStubAssembler) {
  ...
  TNode<Map> tmp32;
  TNode<IntPtrT> tmp33;
  TNode<Union<JSReceiver, Null>> tmp34;
  TNode<IntPtrT> tmp35;
  TNode<Union<JSReceiver, Null>> tmp36;
  TNode<BoolT> tmp37;
  if (block19.is_used()) {
    ...
    tmp34 = CodeStubAssembler(state_).LoadReference<Union<JSReceiver, Null>>(CodeStubAssembler::Reference{tmp32, tmp33});
    tmp35 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp36 = CodeStubAssembler(state_).LoadReference<Union<JSReceiver, Null>>(CodeStubAssembler::Reference{phi_bb19_12, tmp35});
  ...
  if (block25.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<Union<FixedArrayBase, PropertyArray, Smi, SwissNameDictionary>>(CodeStubAssembler::Reference{tmp52, tmp54}, tmp47);
    ...
    CodeStubAssembler(state_).StoreReference<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>>(CodeStubAssembler::Reference{tmp52, tmp56}, tmp0);
    tmp57 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    CodeStubAssembler(state_).StoreReference<Union<BigInt, Boolean, HeapNumber, JSReceiver, Null, Smi, SourceTextModule, String, Symbol, Undefined>>(CodeStubAssembler::Reference{tmp52, tmp57}, tmp46);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/function.tq?l=91&c=13
