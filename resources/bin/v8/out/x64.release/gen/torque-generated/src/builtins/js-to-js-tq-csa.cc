...
TNode<JSAny> ConvertToAndFromWasm_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Int32T> p_wasmType, TNode<JSAny> p_value) {
  ...
  if (block19.is_used()) {
    ...
    tmp26 = Null_0(state_);
    tmp27 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{p_value}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WasmFuncRef, WasmNull, WeakCell>>{tmp26});
...
TF_BUILTIN(JSToJSWrapper, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp35, tmp36, tmp37) = Subslice_int32_0(state_, TorqueStructSlice_int32_ConstReference_int32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp31}, TNode<IntPtrT>{tmp32}, TNode<IntPtrT>{tmp33}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{tmp34}, TNode<IntPtrT>{tmp13}, &label38).Flatten();
    ca_.Goto(&block3);
    if (label38.is_used()) {
      ca_.Bind(&label38);
      ca_.Goto(&block4);
  ...
  if (block3.is_used()) {
    ...
    std::tie(tmp39, tmp40, tmp41) = Subslice_int32_0(state_, TorqueStructSlice_int32_ConstReference_int32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp31}, TNode<IntPtrT>{tmp32}, TNode<IntPtrT>{tmp33}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{tmp13}, TNode<IntPtrT>{tmp21}, &label42).Flatten();
    ca_.Goto(&block7);
    if (label42.is_used()) {
      ca_.Bind(&label42);
      ca_.Goto(&block8);
  ...
  if (block17.is_used()) {
    ...
    std::tie(tmp65, tmp66) = NewReference_int32_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp39}, TNode<IntPtrT>{tmp64}).Flatten();
  ...
  if (block26.is_used()) {
    ...
    tmp80 = ConvertToAndFromWasm_0(state_, TNode<Context>{parameter0}, TNode<Int32T>{tmp67}, TNode<JSAny>{tmp62});
  ...
  if (block37.is_used()) {
    ...
    std::tie(tmp96, tmp97) = NewReference_int32_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp35}, TNode<IntPtrT>{tmp95}).Flatten();
    tmp98 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{tmp96, tmp97});
    tmp99 = ConvertToAndFromWasm_0(state_, TNode<Context>{parameter0}, TNode<Int32T>{tmp98}, TNode<JSAny>{tmp87});
  ...
  if (block49.is_used()) {
    ...
    std::tie(tmp123, tmp124) = NewReference_int32_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp35}, TNode<IntPtrT>{tmp122}).Flatten();
  ...
  if (block58.is_used()) {
    ...
    tmp136 = ConvertToAndFromWasm_0(state_, TNode<Context>{parameter0}, TNode<Int32T>{tmp125}, TNode<JSAny>{tmp120});
...
TorqueStructReference_RawPtr_int32_0 NewOffHeapReference_RawPtr_int32_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_ptr) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = kZeroBitPattern_0(state_);
    tmp1 = Convert_RawPtr_RawPtr_RawPtr_int32_0(state_, TNode<RawPtrT>{p_ptr});
    tmp2 = Convert_intptr_RawPtr_0(state_, TNode<RawPtrT>{tmp1});
    tmp3 = FromConstexpr_intptr_constexpr_int31_0(state_, kHeapObjectTag);
    tmp4 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp3});
    std::tie(tmp5, tmp6) = (TorqueStructReference_RawPtr_int32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp0}, TNode<IntPtrT>{tmp4}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructReference_RawPtr_int32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp5}, TNode<IntPtrT>{tmp6}, TorqueStructUnsafe_0{}};
}
...
TorqueStructSlice_int32_ConstReference_int32_0 NewOffHeapConstSlice_int32_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_startPointer, TNode<IntPtrT> p_length) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = FromConstexpr_intptr_constexpr_int31_0(state_, kHeapObjectTag);
    tmp4 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp3});
    std::tie(tmp5, tmp6, tmp7) = (TorqueStructSlice_int32_ConstReference_int32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp0}, TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{p_length}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructSlice_int32_ConstReference_int32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp5}, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp7}, TorqueStructUnsafe_0{}};
}
...
TorqueStructSlice_int32_ConstReference_int32_0 Subslice_int32_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_int32_ConstReference_int32_0 p_slice, TNode<IntPtrT> p_start, TNode<IntPtrT> p_length, compiler::CodeAssemblerLabel* label_OutOfBounds) {
  ...
  if (block6.is_used()) {
    ...
    std::tie(tmp9, tmp10, tmp11) = NewConstSlice_int32_0(state_, TNode<Union<HeapObject, TaggedIndex>>{p_slice.object}, TNode<IntPtrT>{tmp8}, TNode<IntPtrT>{p_length}).Flatten();
    ca_.Goto(&block7);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block7);
  return TorqueStructSlice_int32_ConstReference_int32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp9}, TNode<IntPtrT>{tmp10}, TNode<IntPtrT>{tmp11}, TorqueStructUnsafe_0{}};
}
