...
TF_BUILTIN(ProxyPreventExtensions, CodeStubAssembler) {
  ...
  if (block12.is_used()) {
    ...
    tmp6 = GetMethod_2(state_, TNode<Context>{parameter0}, TNode<JSAny>{tmp2}, "preventExtensions", &label7);
    ca_.Goto(&block16);
    if (label7.is_used()) {
      ca_.Bind(&label7);
      ca_.Goto(&block17);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp10 = CodeStubAssembler(state_).Call(TNode<Context>{parameter0}, TNode<JSAny>{tmp6}, TNode<JSAny>{tmp2}, TNode<JSAny>{tmp5});
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    tmp12 = ObjectIsExtensibleImpl_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{tmp5});
    tmp13 = True_0(state_);
  ...
  if (block32.is_used()) {
    ca_.Bind(&block32);
    tmp19 = ObjectPreventExtensionsThrow_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{tmp5});
  ...
  if (block33.is_used()) {
    ca_.Bind(&block33);
    tmp20 = ObjectPreventExtensionsDontThrow_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{tmp5});
